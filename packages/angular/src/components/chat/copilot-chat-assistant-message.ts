...
export class CopilotChatAssistantMessage {
  ...
  markdownRendererClass = input<string | undefined>(undefined);
  toolbarClass = input<string | undefined>(undefined);
  copyButtonClass = input<string | undefined>(undefined);
  thumbsUpButtonClass = input<string | undefined>(undefined);
  thumbsDownButtonClass = input<string | undefined>(undefined);
  readAloudButtonClass = input<string | undefined>(undefined);
  regenerateButtonClass = input<string | undefined>(undefined);
  toolCallsViewClass = input<string | undefined>(undefined);

  // Component inputs for overrides
  markdownRendererComponent = input<Type<any> | undefined>(undefined);
  toolbarComponent = input<Type<any> | undefined>(undefined);
  copyButtonComponent = input<Type<any> | undefined>(undefined);
  thumbsUpButtonComponent = input<Type<any> | undefined>(undefined);
  thumbsDownButtonComponent = input<Type<any> | undefined>(undefined);
  readAloudButtonComponent = input<Type<any> | undefined>(undefined);
  regenerateButtonComponent = input<Type<any> | undefined>(undefined);
  toolCallsViewComponent = input<Type<any> | undefined>(undefined);
