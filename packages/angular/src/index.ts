...
export { SlotRegistryService } from './lib/slots/slot-registry.service';
export { SmartSlotDirective } from './lib/slots/smart-slot.directive';
export { SlotProxyDirective } from './lib/slots/slot-proxy.directive';
