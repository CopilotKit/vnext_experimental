---
title: "Development"
description: "Development workflow and best practices for CopilotKit vnext_experimental"
---

## Development Workflow

CopilotKit vnext_experimental uses a modern development stack with pnpm workspaces and Turborepo for optimal developer experience.
...
pnpm add <package-name> --filter @copilotkitnext/runtime

# Add a dev dependency
pnpm add -D <package-name> --filter @copilotkitnext/shared
```
...
pnpm test --filter @copilotkitnext/runtime

# Watch specific package
pnpm test:watch --filter @copilotkitnext/shared
```
